...
int main(int argc, char **argv, char **env)
{
    ...
    svSetScope(svGetScopeFromName("TOP.tb_top_verilator.cv32e20_tb_wrapper_inst.ram_inst.dp_ram_inst"));
...
void dump_memory()
{
    ...
    try {
        ...
        for (size_t i = 0; i < 1048576; i++) {
            ...
            // mike@openhwgroup.org: if the above line fails to compile on your system, try this line
            //uint32_t val = read_byte(&addr.aval);
